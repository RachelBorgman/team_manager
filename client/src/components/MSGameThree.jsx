                            ...
                            {playerList && playerList.map((player)=>{
                                return(
                                    <tr key={player._id}>
                                        ...
                                        <td>
                                            <Button className={`${player.gameThreeStatus == "Playing" ? "playingStatus": ""}`}
                                                onClick={() =>
                                                handlePlayingStatus(player._id, "Playing")
                                                }>Playing
                                            </Button>
                                            <Button className={`${player.gameThreeStatus == "Not Playing" ? "notPlaying" : ""}`}
                                                onClick={() =>
                                                handlePlayingStatus(player._id, "Not Playing")
                                                }>Not Playing
                                            </Button>
                                            <Button className={`${player.gameThreeStatus == "Undecided" ? "undecided" : ""}`}
                                                onClick={() =>
